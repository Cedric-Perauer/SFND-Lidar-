...
std::pair<pcl::PointCloud<pcl::PointXYZ>::Ptr, pcl::PointCloud<pcl::PointXYZ>::Ptr> RANSAC_Segmentation(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, int maxIterations, float distanceTol,std::unordered_set<int> &inliers)
{
	inliers = Ransac3D(cloud, maxIterations, distanceTol);
	...
	return std::pair<pcl::PointCloud<pcl::PointXYZ>::Ptr, pcl::PointCloud<pcl::PointXYZ>::Ptr> {cloudInliers,cloudOutliers};
...
int main ()
{
	...
	std::pair<pcl::PointCloud<pcl::PointXYZ>::Ptr, pcl::PointCloud<pcl::PointXYZ>::Ptr> segmentCloud = RANSAC_Segmentation(cloud,50,0.5,inliers);
